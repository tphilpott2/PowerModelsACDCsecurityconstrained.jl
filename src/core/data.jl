...
function fix_scopf_data_issues!(data;
    define_contingencies=true, split_large_coal_gens=true,
    ...
    if define_contingencies
        ...
        data["gen_contingencies"] = Any[]
        data["branch_contingencies"] = Any[]
        data["branchdc_contingencies"] = Any[]
        data["convdc_contingencies"] = Any[]
    end
    return data
end
